...
import { ArrowLeft, Bell, Save, Mic, X } from 'lucide-react';
  ...
  return (
    <div className="screen-container">
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        {/* 1. Transaction Name Input with Autocomplete */}
        ...
        {/* 3. Transaction Name / Description Input */}
        <div className="input-group">
